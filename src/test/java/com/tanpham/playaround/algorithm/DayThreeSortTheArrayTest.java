...
import com.tanpham.playaround.algorithm.Day3SortTheArray.Range;
...
public class DayThreeSortTheArrayTest {
	...
	public void myTestCase01() {
		...
		assertThat(Day3SortTheArray.getPositionsIfExistThatKindOfArray(arr), Matchers.nullValue());
	}
	...
	public void testCast01() {
		...
		Range range = Day3SortTheArray.getPositionsIfExistThatKindOfArray(arr);
